...
The page/document you are currently looking at is the *Official Documentation for the CX Setup scripting language*. It was made primarily by Matthew ([[https://mf366-dev.github.io][MF366]]) using ~Org Mode~ on ~Emacs~, later exported to ~HTML~.
...
If those rules did not scare you away, the GitHub repository is [[https://github.com/mf366-dev/mf366-dev.github.io][right here]]. Thanks ahead for your contributions.
...
>>> REQUIRES ?? 1 ?? "mf366-dev/WPlugZ-CLI"; // the 1 uses ContenterX itself to install ("Install using ContenterX")
...
>>> REQUIRES ?? 4 ?? "https://github.com/mf366-dev/WriterClassic/releases/download/v11.0.0/WriterClassic_v11.0.0_SetupWizard_x64.exe"; // source number 4 stands for "Get binary from a direct link" - you'll be using this a lot in Windows
...
- [[https://github.com/mf366-dev/CXSetup/blob/main/cxhighlight.py][*CX Setup Syntax Highlighter*]] (can be used in the terminal or imported and used from a Python file)
...
- [[https://gist.github.com/mf366-dev/6b65eeb415e3e6bfe86783b496193850][*CX Setup Language Major Mode for Emacs*]] (syntax highlighting for Emacs)
