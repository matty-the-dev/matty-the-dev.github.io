...
The page/document you are currently looking at is the *Official Documentation for Terminal Supaplex Editor a.k.a. TSpE*. It was made primarily by Matthew ([[https://mf366-dev.github.io][MF366]]) using ~Org Mode~ on ~Emacs~, later exported to ~HTML~.
...
*** ~web~ / ~repo~
The commands ~web~ and ~repo~ both open [[https://github.com/mf366-dev/TSpE][TSpE's GitHub Repository]].
